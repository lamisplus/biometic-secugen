...
import org.lamisplus.modules.secugen.config.SecugenProperties;
...
public class SecugenManager {
    ...
    public BiometricTemplate verifyFingerPrint(byte[] storedTemplate) {
        ...
        if (matched && matched2) {
            ...
            return mapBiometricTemplate(biometricTemplate, imageQuality, imageQuality2, regTemplate, regTemplate2, imageBuffer, imageBuffer2);
        }
        return null;
    }

    private BiometricTemplate mapBiometricTemplate(BiometricTemplate biometricTemplate, int imageQuality, int imageQuality2,
